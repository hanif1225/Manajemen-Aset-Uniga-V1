...
<h2 align="center" style="color:#1E90FF"><i class="fas fa-boxes"></i> <b>Data Inventarisir Yang Sedang Diperbaiki</b></h2>
    ...
    <table class="table">
        <br>
            ...
            if(isset($_POST['pencarian'])){
                ...
                where kondisi='diperbaiki' and nm_barang like '%$keyword%' order by nm_barang ASC limit $mulai,$halaman";
            }
              ...
              echo "<script>window.location='export.php'</script>";
                ...
                $sql = "SELECT * from inventaris INNER JOIN nama_barang on nama_barang.id_barang=inventaris.id_barang
                INNER JOIN nama_lokasi on nama_lokasi.id_lokasi=inventaris.id_lokasi where kondisi='diperbaiki' order by id_inventaris ASC limit $mulai,$halaman";
                }
            ...
            ?>
                <tr>
                    ...
                    <a href=<?php echo "'proses_selesai.php?id_inventaris=$row[id_inventaris]'" ?>  class='btn btn-primary btn-sm'><i class="fas fa-magic"></i></a>
                    <a href=<?php echo "'detail_data_diperbaiki.php?id_inventaris=$row[id_inventaris]'" ?>  class='btn btn-success btn-sm'><i class="fas fa-info-circle"></i></a>
